...
class Serfile():
    ...
    def __init__(self, name_of_serfile, NEW=False, header=None):
        ...
        if not NEW:
            ...
            self._frameDimension = self._header['ImageWidth'] * self._header[
                'ImageHeight']  # frame dimension, nb of Bytes
    ...
    def readTrailFromHeader(self):
        ...
        trail = []
        offset = self._header['ImageHeight'] * self._header['ImageWidth'] * self._header[
            'FrameCount'] * self._bytesPerPixels + 178
...
if __name__ == "__main__":
    ...
    if new_ser_flag:
        ...
        # test purpose####
        header = {'FileID': 'LUCAM-RECORDER', 'LuID': 0, 'ColorID': 0, 'LittleEndian': 0, 'ImageWidth': 88,
                  'ImageHeight': 896, 'PixelDepthPerPlane': 16, 'FrameCount': 3884, 'Observer': 'SHELYAK',
                  'Instrument': 'ASI=ZWO ASI290MM Minitemp=32.0', 'Telescope': 'fps=80.00gain=30exp=0.38',
                  'DateTime': 637425855694020000, 'DateTimeUTC': 637425855693860000}
        #################
